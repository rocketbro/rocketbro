...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'text',
      rows: 4,
      description: 'A short description of the post (used for previews and meta descriptions)',
    }),
    defineField({
      name: 'mainImage',
      title: 'Main Image',
    ...
    defineField({
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'image',
          description: 'Image for social media sharing (leave empty to use main image)',
          options: {
            hotspot: true,
          },
          fields: [
